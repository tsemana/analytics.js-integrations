  ...
  describe('after loading', function(){
    ...
    describe('#listen', function(){
      ...
      it('should send a chat started event', function(done){
        window.olark('api.chat.sendNotificationToOperator', { body: 'hello' });
        setTimeout(function(){
          analytics.called(analytics.track, 'Live Chat Started', {}, { context: { integration: { name: 'olark', version: '1.0.0' }}});
          done();
        }, 3000);
      });

      it('should send a chat sent event', function(done){
        window.olark('api.chat.sendNotificationToOperator', { body: 'hi' });
        setTimeout(function(){
      ...
      it('should send a chat received event', function(done){
        ...
        setTimeout(function(){
          analytics.called(analytics.track, 'Live Chat Message Received', { messageBody: 'oh hai' }, { context: { integration: { name: 'olark', version: '1.0.0' }}});
          done();
        }, 3000);
      });
    });
