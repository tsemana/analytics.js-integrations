...
describe('Quantcast', function(){
  var Quantcast = plugin.Integration;
  var quantcast;
  var analytics;
  var options = {
  ...
  it('should have the right settings', function(){
    var Test = integration('Quantcast')
      .assumesPageview()
      .readyOnLoad()
      .global('_qevents')
      .global('__qc')
    ...
    analytics.validate(Quantcast, Test);
  });
  ...
  describe('before loading', function(){
    ...
    describe('#loaded', function(){
      it('should test window.__qc', function(){
        analytics.assert(!quantcast.loaded());
        window.__qc = {};
        analytics.assert(quantcast.loaded());
      });
    });
  ...
  describe('after loading', function(){
    describe('#page', function(){
      ...
      it('should call `#initialize` with `#page` once the integration is ready', function(){
        ...
        analytics.page('name');
        analytics.assert('page' == quantcast.initialize.args[0][0].action());
      });
