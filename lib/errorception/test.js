...
var tester = require('segmentio/analytics.js-integration-tester@1.3.x');
var plugin = require('./');

describe('Errorception', function(){
  var Errorception = plugin.Integration;
  var noop = function(){};
  var errorception;
  var analytics;
  var onerror;
  var options = {
    projectId: '538d0567f0450f9b6c0005c3'
  };
  ...
  it('should have the right settings', function(){
    analytics.validate(Errorception, integration('Errorception')
      .assumesPageview()
      .readyOnLoad()
      .global('_errs')
      .option('projectId', '')
