...
describe('Optimizely', function(){
  ...
  describe('before loading', function(){
    beforeEach(function(){
      ...
      analytics.stub(optimizely, 'sendRoots');
    });
    ...
    describe('#initialize', function(){
      ...
      it('should call #sendRoots if listen is enabled', function(done){
        optimizely.options.listen = true;
        analytics.initialize();
        analytics.page();
        tick(function(){
          analytics.called(optimizely.sendRoots);
          done();
        });
      });

      it('should not call #sendRoots if listen is disabled', function(done){
        optimizely.options.listen = false;
        analytics.initialize();
        analytics.page();
        tick(function(){
          analytics.didNotCall(optimizely.sendRoots);
          done();
        });
      });
    });
