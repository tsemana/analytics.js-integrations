...
describe('AdRoll', function(){
  ...
  describe('before loaded', function(){
    beforeEach(function(){
      analytics.spy(AdRoll.prototype, 'load');
    });
    ...
    describe('#initialize', function(){
      ...
      it('should call #load', function(){
        analytics.initialize(settings);
        analytics.page();
        analytics.called(AdRoll.prototype.load);
      });
  ...
  describe('after loaded', function(){
    ...
    describe('#page', function(){
      beforeEach(function(){
        analytics.spy(window.__adroll, 'record_user');
      });
    ...
    describe('#track', function(){
      ...
      describe('event in events', function(){
        beforeEach(function(){
          integration.options.events = { event: 'segment' };
        });
        ...
        it('should include the user_id when available', function(){
          analytics.user().identify('id');
          analytics.track('event', { revenue: 3.99 });
          analyics.called(window.__adroll.record_user, {
            adroll_segments: 'segment',
