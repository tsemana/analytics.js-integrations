...
Curebit.prototype.load = function(fn){
  ...
  if (!tags) this.injectIntoBody(script, fn);
  else this.injectIntoId(script, this.options.insertIntoId, fn);
};

/**
 * injectIntoBody
 * 
 * If we're not loading a campaign, just get it into the body.
 */

Curebit.prototype.injectIntoBody = function(script, fn) {
...
Curebit.prototype.injectIntoId = function(script, id, fn) {
  when(function () {
