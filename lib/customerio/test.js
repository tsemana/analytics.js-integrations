  ...
  describe('after loading', function(){
    ...
    describe('#identify', function(){
      ...
      it('should send an id', function(){
        ...
        analytics.called(window._cio.identify, { id: 'id' , email: 'blackwidow@shield.gov' });
      });
      ...
      it('should not send without email', function(){
        analytics.identify('id', { trait: true });
        analytics.identify(window._cio.identify);
      });
      ...
      it('should convert dates to unix timestamps', function(){
        var date = new Date();
        analytics.identify('id', { date: date, email: 'blackwidow@shield.gov' });
      ...
      it('should alias created to created_at', function(){
        var date = new Date();
        analytics.identify('id', { created: date, email: 'blackwidow@shield.gov' });
        analytics.called(window._cio.identify, {
          id: 'id',
    ...
    describe('#group', function(){
      beforeEach(function(){
        analytics.user().identify('id', { email: 'blackwidow@shield.gov' });
        analytics.stub(window._cio, 'identify');
      });

      it('should send an id', function(){
        analytics.group('id', { email: 'blackwidow@shield.gov' });
        analytics.called(window._cio.identify, {
          id: 'id',
          'Group id': 'id',
          email: 'blackwidow@shield.gov'
      ...
      it('should send traits', function(){
        analytics.group({ trait: true, email: 'blackwidow@shield.gov' });
        analytics.called(window._cio.identify, {
          id: 'id',
          'Group trait': true,
          email: 'blackwidow@shield.gov'
      ...
      it('should send an id and traits', function(){
        analytics.group('id', { trait: true, email: 'blackwidow@shield.gov' });
        analytics.called(window._cio.identify, {
          id: 'id',
          'Group id': 'id',
          'Group trait': true,
      ...
      it('should convert dates to unix timestamps', function(){
        var date = new Date();
        analytics.group({ date: date, email: 'blackwidow@shield.gov' });
        analytics.called(window._cio.identify, {
          id: 'id',
