...
describe('GoSquared', function(){
  var GoSquared = plugin.Integration;
  var gosquared;
  var analytics;
  var options = {
    siteToken: 'x'
  ...
  it('should have the right settings', function(){
    var Test = integration('GoSquared')
      .assumesPageview()
      .readyOnLoad()
      .global('_gs')
      .option('siteToken', '')
    ...
    analytics.validate(GoSquared, Test);
  });
  ...
  describe('before loading', function(){
    ...
    describe('#loaded', function(){
      it('should test window._gs.v', function(){
        analytics.assert(!gosquared.loaded());
  ...
  describe('after loading', function(){
    ...
    describe('#page', function(){
      ...
      it('should prefer a name', function(){
        analytics.page(null, 'name', { path: '/path', title: 'title' });
