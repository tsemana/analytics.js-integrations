...
describe('UserVoice', function(){
  var UserVoice = plugin.Integration;
  var uservoice;
  var analytics;
  var options = {
  ...
  it('should store the right settings', function(){
    var Test = integration('UserVoice')
      .assumesPageview()
      .readyOnLoad()
      .global('UserVoice')
      .option('apiKey', '')
    ...
    analytics.validate(UserVoice, Test);
  });
    ...
    describe('before loading', function(){
      ...
      describe('#loaded', function(){
        it('should test window.UserVoice.push', function(){
          window.UserVoice = [];
          analytics.assert(!uservoice.loaded());
    ...
    describe('after loading', function(){
      ...
      describe('#identify', function(){
        ...
        it('should send an id and traits', function(){
          analytics.identify(null, { id: 'id', trait: true });
          analytics.called(window.UserVoice.push, [
            'identify',
            { id: 'id', trait: true }
          ]);
        ...
        it('should convert a created date', function(){
          var date = new Date();
          analytics.identify(null, { created: date });
          analytics.called(window.UserVoice.push, [
            'identify',
      ...
      describe('#group', function(){
        ...
        it('should send an id and properties', function(){
          analytics.group(null, { id: 'id', property: true });
          analytics.called(window.UserVoice.push, [
            'identify',
        ...
        it('should convert a created date', function(){
          var date = new Date();
          analytics.group(null, { created: date });
          analytics.called(window.UserVoice.push, [
            'identify',
