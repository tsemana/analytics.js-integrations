...
describe('Tapstream', function(){
  ...
  it('should store the right settings', function(){
    ...
    analytics.validate(Tapstream, Test);
  });
  ...
  describe('before loading', function(){
    ...
    describe('#loaded', function(){
      it('should test window._tsq.push', function(){
        window._tsq = [];
        analytics.assert(!tapstream.loaded());
  ...
  describe('after loading', function(){
    ...
    describe('#page', function(){
      ...
      it('should track all pages by default', function(){
        analytics.page();
        analytics.called(window._tsq.push, ['fireHit', 'loaded-a-page', [window.location.href]]);
      });

      it('should track named pages by default', function(){
        analytics.page(null, 'Name');
        analytics.called(window._tsq.push, ['fireHit', 'viewed-name-page', [window.location.href]]);
      });

      it('should track named pages with a category', function(){
        analytics.page('Category', 'Name');
        analytics.called(window._tsq.push, ['fireHit', 'viewed-category-name-page', [window.location.href]]);
      });

      it('should track categorized pages by default', function(){
        analytics.page('Category', 'Name');
        analytics.called(window._tsq.push, ['fireHit', 'viewed-category-page', [window.location.href]]);
      });
