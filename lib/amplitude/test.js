...
describe('Amplitude', function(){
  ...
  describe('before loading', function(){
    ...
    describe('#initialize', function(){
      ...
      it('should set domain in amplitude', function(){
        window.location.href = 'https://sub.segment.com/?query=search'
        analytics.initialize();
        analytics.called(amplitude.setDomain('segment.com'));
      });


      it('should set campaign object as global user property', function(){
        window.location.search = '?utm_source=source&utm_medium=medium&utm_term=term&utm_content=content&utm_campaign=name';
        analytics.initialize();
        analytics.called(window.amplitude.setGlobalUserProperties, { 
          campaign: { 
            source: 'source', 
            medium: 'medium', 
            term: 'term', 
...
>>>>>>> aedcc51... update test
  ...
  describe('after loading', function(){
    ...
    describe('#track', function(){
      ...
      it('should send an event with campaign object', function(){
        window.location.search = '?utm_source=source&utm_medium=medium&utm_term=term&utm_content=content&utm_campaign=campaign'
        analytics.track('event');
        analytics.called(window.amplitude.logEvent, 'event', { 
          campaign: { 
            source: 'source', 
