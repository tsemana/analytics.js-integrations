...
/* can't get this one to work
      it('should set domain', function(){
        ...
        plugin.global.location.href = 'https://sub.domain.com/path';
        analytics.initialize();
        analytics.page();
...
/* or this one
      it('should set campaign object as global user property', function(){
        ...
        analytics.initialize();
        analytics.page();
        analytics.called(window.amplitude.setGlobalUserProperties, {campaign: {source:'source', medium:'medium', term:'term', content:'content', name:'name'}});
        plugin.global = window;
      });
*/
    });
